...
class ScriptGenerator:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "7. REALISTIC TIMING BUDGET: In a 15-second video, limit interactive items to 3 to 5 items max (e.g., counting 1 to 3 or 1 to 5, or 3 distinct colors/shapes) so each item gets 3-5 seconds for visual pop and narration sync.\n"
            "8. Mascot SFX: Mascots NEVER speak human words. Dookie (puppy barks/woofs), Mia (meows/purrs), Carrot (squeaks/crunch).\n"
