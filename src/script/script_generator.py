...
class ScriptGenerator:
    ...
    def _build_system_prompt(self) -> str:
        return (
            ...
            "Rule 9: NO AI-generated text or subtitles on screen. Mandate: 'NO on-screen text, NO subtitles, NO captions generated by AI. Plain clean 3D video frames only.'\n"
            "Rule 10: Output valid JSON ONLY adhering to the requested schema."
        )
