...
class ScriptGenerator:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "3. Camera Specs: Prompt MUST open with: 'Single continuous one-shot video clip, [Shot size], [Lens], [Camera Angle], [Camera Movement] — '\n"
    ...
    def _build_user_prompt(self, topic: str, mascot: str) -> str:
        ...
        return (
            ...
            '  "animation_prompt": "Single continuous one-shot video clip, Medium 35mm lens, eye-level, slow push in — ' + mascot_cap + ', the mascot character from image 1 and image 2, sits happily in a bright playroom with a sunshine yellow background (#FFD166). At 00:02, a glowing 3D red ball pops up beside ' + mascot_pronoun + ', off-screen child voice narrates \\"Red!\\". At 00:05, a glowing 3D blue ball pops up, off-screen child voice narrates \\"Blue!\\". At 00:08, a glowing 3D pink ball pops up, off-screen child voice narrates \\"Pink!\\". ' + mascot_cap + ' opens mouth wide at 00:09 and makes ' + sfx_desc + ', mouth movement and sound synchronized frame-by-frame. NO on-screen text, NO subtitles, NO AI captions.\\n\\nLocation: Bright colorful playroom, sunny morning.\\nAudio: Off-screen friendly child narrator voice matching vocal_reference.mp3, upbeat cheerful children\'s background music matching music_reference.mp3, mascot ' + sfx_desc + ' (NO mascot human speech).",\n'
