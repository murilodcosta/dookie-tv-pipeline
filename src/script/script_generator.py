...
class ScriptGenerator:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "3. Camera Specs: Prompt MUST open with 4 camera parameters: Shot size (Wide/Medium/Close-up), Lens (24mm/35mm/50mm), Camera Angle (Low angle/High angle/Eye-level), Camera Movement (Slow push in/Pull out/Track/Orbit/Static).\n"
